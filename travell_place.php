...
<html lang="en">
  ...
  <link rel="stylesheet" href="./style.css" />
    ...
    <form action="travell_place_process.php" class="home-offers" method="post">
        <?php
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<img alt='image' src='" . $row['image'] . "' class='image' />";
                echo "<div class='offer-content'>";
                echo "<span class='offer-text'><span>" . $row['location'] . "</span></span>";
                echo "<span class='offer-text1'><span>" . $row['spot_name'] . "</span></span>";
                echo "<span class='offer-text2'><span>" . $row['description'] . "</span></span>";
                echo "<span class='offer-text2'><span>" . $row['division'] . "</span></span>";
                echo "<span class='offer-text2'><span>" . $row['district'] . "</span></span>";
                echo "<span class='offer-text2'><span>" . $row['avg_cost'] . "</span></span>";
                
                echo "<input type='checkbox' name='selected_tourist_spots[]' value='" . $row['id'] . "'> ";
                echo "</div>";
                echo "</div>";
